...
$arrayValue    = [0=>"1.259,99",1=>"80,00",2=>"236,55",3=>"896,00",4=>"58,00",5=>"630,00",6=>"56,00",7=>"780,00"];
	...
	$response = '
        <div class="div_item" draggable="true">
            ...
            <div class="div_item_details">
                <p><strong>Nome: </strong>'.$arrayName[$randItemId].'</p>
                <p><strong>Valor: </strong>R$ '.$arrayValue[$randItemId].'</p>
                <p><strong>Categoria: </strong>'.$arrayCategory[$randItemId].'</p>
                <p><strong>Estoque: </strong>'.$arrayStock[$randItemId].'</p>
                <input type="hidden" name="hidden_item_details" id="hidden_item_details" value="'.$value.'" />
            </div>
        </div>';
